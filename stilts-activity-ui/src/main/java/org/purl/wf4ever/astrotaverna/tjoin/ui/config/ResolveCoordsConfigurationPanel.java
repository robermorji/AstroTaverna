...
public class ResolveCoordsConfigurationPanel
		extends
		ActivityConfigurationPanel<ResolveCoordsActivity, 
	...
	public ResolveCoordsConfigurationPanel(ResolveCoordsActivity activity) {
