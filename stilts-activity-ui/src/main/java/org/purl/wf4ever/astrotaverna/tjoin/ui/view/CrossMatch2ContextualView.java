...
public class CrossMatch2ContextualView extends ContextualView {
	private final CrossMatch2Activity activity;
	private JTextArea description;
	private javax.swing.JScrollPane jScrollPane1;

	public CrossMatch2ContextualView(CrossMatch2Activity activity) {
	...
	public JComponent getMainFrame() {
		...
		description.setText("The service returns a votable resulting from crossmatching two votables. " +
				"Using the configure service option you can choose between direct votable input, " +
				"a URL or a File. There additional configuration options according to stilts and topcat documentation. " +
				"If the input is a file path then the output is a File path whereas the output " +
	...
	public Action getConfigureAction(final Frame owner) {
		return new CrossMatch2ConfigureAction(activity, owner);
	} 
