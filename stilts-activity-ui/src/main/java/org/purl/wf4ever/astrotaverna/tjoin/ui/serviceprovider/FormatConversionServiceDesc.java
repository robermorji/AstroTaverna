...
public class FormatConversionServiceDesc extends ServiceDescription<FormatConversionActivityConfigurationBean> {
	 ...
	 */
	@Override
	public Class<? extends Activity<FormatConversionActivityConfigurationBean>> getActivityClass() {
		return FormatConversionActivity.class;
	} 
