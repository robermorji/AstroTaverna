...
public class CoordTransformationConfigurationPanel
		extends
		ActivityConfigurationPanel<CoordTransformationActivity, 
	...
	public CoordTransformationConfigurationPanel(CoordTransformationActivity activity) {
	...
	protected void initGui() {
		...
		labelString = new JLabel("Coordenates transformation:");
		add(labelString);
		
		typeOfFilter = new JComboBox(activity.getListOfCoordenatesFunctions());
		add(typeOfFilter);
	...
	public boolean checkValues() {
		...
		if(! activity.isAllowedCoordenatesFunction(tfilter)){
			//"Invalid filter type
			errorMessage = "Invalid coordenates transformation function";
		}
