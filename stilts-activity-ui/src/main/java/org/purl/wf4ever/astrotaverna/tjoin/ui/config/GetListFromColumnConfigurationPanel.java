...
public class GetListFromColumnConfigurationPanel
		extends
		ActivityConfigurationPanel<GetListFromColumnActivity, 
        GetListFromColumnActivityConfigurationBean> {

	private GetListFromColumnActivity activity;
	...
	public GetListFromColumnConfigurationPanel(GetListFromColumnActivity activity) {
