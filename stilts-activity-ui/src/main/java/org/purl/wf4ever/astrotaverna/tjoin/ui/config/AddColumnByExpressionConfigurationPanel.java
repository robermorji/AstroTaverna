...
public class AddColumnByExpressionConfigurationPanel
		extends
		ActivityConfigurationPanel<AddColumnByExpressionActivity, 
        AddColumnByExpressionActivityConfigurationBean> {

	private AddColumnByExpressionActivity activity;
	...
	public AddColumnByExpressionConfigurationPanel(AddColumnByExpressionActivity activity) {
