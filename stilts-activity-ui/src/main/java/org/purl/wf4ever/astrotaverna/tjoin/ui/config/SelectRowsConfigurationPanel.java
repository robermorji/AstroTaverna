...
public class SelectRowsConfigurationPanel
		extends
		ActivityConfigurationPanel<SelectRowsActivity, 
        SelectRowsActivityConfigurationBean> {

	private SelectRowsActivity activity;
	...
	public SelectRowsConfigurationPanel(SelectRowsActivity activity) {
