...
public class SelectRowsServiceDesc extends ServiceDescription<SelectRowsActivityConfigurationBean> {
	 ...
	 */
	@Override
	public Class<? extends Activity<SelectRowsActivityConfigurationBean>> getActivityClass() {
		return SelectRowsActivity.class;
	} 
	 ...
	 */
	@Override
	public SelectRowsActivityConfigurationBean getActivityConfiguration() {
		SelectRowsActivityConfigurationBean bean = new SelectRowsActivityConfigurationBean();
