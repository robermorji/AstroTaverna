...
public class SelectColumnsServiceDesc extends ServiceDescription<SelectColumnsActivityConfigurationBean> {
	 ...
	 */
	@Override
	public Class<? extends Activity<SelectColumnsActivityConfigurationBean>> getActivityClass() {
		return SelectColumnsActivity.class;
	}
