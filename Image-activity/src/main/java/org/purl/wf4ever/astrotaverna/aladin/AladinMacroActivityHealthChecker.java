 ...
 * @since    7 Mar 2013
 */
public class AladinMacroActivityHealthChecker implements
		HealthChecker<AladinMacroActivity> {
	...
	public boolean canVisit(Object o) {
		...
		return o instanceof AladinMacroActivity;
	}
	...
	public VisitReport visit(AladinMacroActivity activity, List<Object> ancestry) {
		AladinMacroActivityConfigurationBean config = activity.getConfiguration();
