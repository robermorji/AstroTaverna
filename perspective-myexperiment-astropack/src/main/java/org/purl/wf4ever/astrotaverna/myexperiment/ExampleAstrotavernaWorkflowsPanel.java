...
import net.sf.taverna.t2.ui.perspectives.myexperiment.ResourcePreviewBrowser;
...
public class ExampleAstrotavernaWorkflowsPanel extends JPanel implements ActionListener, ChangeListener {
  ...
  private static final int RESOURCE_BROWSER_PREFERRED_SCROLL = 10;

  private net.sf.taverna.t2.ui.perspectives.myexperiment.MainComponent pluginMainComponent;
  private net.sf.taverna.t2.ui.perspectives.myexperiment.model.MyExperimentClient myExperimentClient;
  ...
  public ExampleAstrotavernaWorkflowsPanel(net.sf.taverna.t2.ui.perspectives.myexperiment.MainComponent component, net.sf.taverna.t2.ui.perspectives.myexperiment.model.MyExperimentClient client, Logger logger) {
	super();
  ...
  public void refresh() {
	...
	new Thread("Refresh for ExampleWorkflowsPanel") {
	  public void run() {
		...
		try {
			AstroPackClient client = new AstroPackClient(myExperimentClient);
		  workflows = client.getExampleAstrotavernaWorkflows();
  ...
  private void initialiseUI() {
	...
	spExampleWorkflowList.getVerticalScrollBar().setUnitIncrement(RESOURCE_BROWSER_PREFERRED_SCROLL);
