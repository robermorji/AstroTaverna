...
//	static {
//		Observer<SPIRegistryEvent> observer = new Observer<SPIRegistryEvent>() {
//			@Override
//			public void notify(Observable<SPIRegistryEvent> arg0, SPIRegistryEvent arg1) throws Exception {
//				
//				PerspectiveCheckerThread t = new PerspectiveCheckerThread();
//				
//				t.start();
//			}
//		};
//		PerspectiveRegistry.getInstance().addObserver(observer);
//	}
...
//	
//	
//	public static class AstroPackInitializer extends Thread {
...
//	  }
  ...
  public static final String PERSPECTIVE_NAME = "myExperiment_astropack";
