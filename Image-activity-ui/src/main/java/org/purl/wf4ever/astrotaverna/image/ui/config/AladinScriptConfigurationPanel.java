...
public class AladinScriptConfigurationPanel
		extends
		ActivityConfigurationPanel<AladinScriptActivity, 
        AladinScriptActivityConfigurationBean> {

	private AladinScriptActivity activity;
	...
	public AladinScriptConfigurationPanel(AladinScriptActivity activity) {
