 ...
 * @since    19 May 2011
 */
public class ValidationPDLClientHealthChecker implements
		HealthChecker<ValidationPDLClientActivity> {
	...
	public boolean canVisit(Object o) {
		...
		return o instanceof ValidationPDLClientActivity;
	}
	...
	public VisitReport visit(ValidationPDLClientActivity activity, List<Object> ancestry) {
		ValidationPDLClientActivityConfigurationBean config = activity.getConfiguration();
