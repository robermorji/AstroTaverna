...
public class SIAServiceDesc extends ServiceDescription<RESTActivityConfigurationBean> {
	...
	public RESTActivityConfigurationBean getActivityConfiguration() {
		...
		RESTActivityConfigurationBean configurationBean = RESTActivityConfigurationBean
				.getDefaultInstance();
		configurationBean.setUrlSignature("http://www.exampleuri.com/CS&POS={POS}&SIZE={SIZE}");
		configurationBean
	...
	public String getName() {
		return "Access SIA VOService";//exampleString;
	}
