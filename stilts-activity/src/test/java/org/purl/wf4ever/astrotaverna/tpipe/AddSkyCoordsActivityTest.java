 ...
 */
public class AddSkyCoordsActivityTest {

	private AddSkyCoordsActivityConfigurationBean configBean;
	
	//this variables must be the same than the ones defined at AddSkyCoordsActivity.java
	...
	private AddSkyCoordsActivity activity = new AddSkyCoordsActivity();
	...
	public void makeConfigBean() throws Exception {
		...
		configBean.setTypeOfInSystem("fk4");
		configBean.setTypeOfOutSystem("galactic");
		
	}

	@Test(expected = ActivityConfigurationException.class)
	public void invalidConfiguration() throws ActivityConfigurationException {
		AddSkyCoordsActivityConfigurationBean invalidBean = new AddSkyCoordsActivityConfigurationBean();
		invalidBean.setTypeOfInput("File");
		invalidBean.setTypeOfInSystem("fk4-fk");
		invalidBean.setTypeOfOutSystem("galactic");
	...
	public void invalidConfiguration2() throws ActivityConfigurationException {
		...
		invalidBean.setTypeOfInSystem("fk4");
		invalidBean.setTypeOfOutSystem("galactic");
		// Should throw ActivityConfigurationException
		activity.configure(invalidBean);
	}
	...
	public void executeAsynchWithStrings() throws Exception {
		...
		try{
			...
			//String a = new String(resultAddSkyCoords.toCharArray());
			...
			assertTrue("Wrong output: ", ((String)outputs.get(OUT_SIMPLE_OUTPUT)).indexOf("latitute")!=-1);
			assertTrue("Wrong output: ", ((String)outputs.get(OUT_SIMPLE_OUTPUT)).indexOf("longitude")!=-1);
	...
	public void executeAsynchWithNullInput() throws Exception {
		...
		assertTrue("Wrong output: ", ((String)outputs.get(OUT_SIMPLE_OUTPUT)).indexOf("latitude")!=-1);
		assertTrue("Wrong output: ", ((String)outputs.get(OUT_SIMPLE_OUTPUT)).indexOf("longitude")!=-1);
	...
	private static final String resultAddSkyCoords = 	
			"<?xml version='1.0'?>"
					+ "<VOTABLE version=\"1.1\""
