...
/**
 * Get list from column health checker
 * @author Julian Garrido
 * @since    19 May 2011
 */
public class GetListFromColumnActivityHealthChecker implements
		HealthChecker<GetListFromColumnActivity> {
	...
	public boolean canVisit(Object o) {
		...
		return o instanceof GetListFromColumnActivity;
	}
	...
	public VisitReport visit(GetListFromColumnActivity activity, List<Object> ancestry) {
		GetListFromColumnActivityConfigurationBean config = activity.getConfiguration();
