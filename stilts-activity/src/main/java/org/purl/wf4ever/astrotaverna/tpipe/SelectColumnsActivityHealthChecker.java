 ...
 * @since    19 May 2011
 */
public class SelectColumnsActivityHealthChecker implements
		HealthChecker<SelectColumnsActivity> {
	...
	public boolean canVisit(Object o) {
		...
		return o instanceof SelectColumnsActivity;
	}
	...
	public VisitReport visit(SelectColumnsActivity activity, List<Object> ancestry) {
		SelectColumnsActivityConfigurationBean config = activity.getConfiguration();
