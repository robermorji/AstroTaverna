 ...
 * @since    19 May 2011
 */
public class TcatActivityHealthChecker implements
		HealthChecker<TcatActivity> {
	...
	public boolean canVisit(Object o) {
		...
		return o instanceof TcatActivity;
	}
	...
	public VisitReport visit(TcatActivity activity, List<Object> ancestry) {
		TcatActivityConfigurationBean config = activity.getConfiguration();
