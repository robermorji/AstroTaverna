 ...
 * 
 */
public class TjoinActivityHealthChecker implements
		HealthChecker<TjoinActivity> {
	...
	public boolean canVisit(Object o) {
		...
		return o instanceof TjoinActivity;
	}
	...
	public VisitReport visit(TjoinActivity activity, List<Object> ancestry) {
		TjoinActivityConfigurationBean config = activity.getConfiguration();
