 ...
 * @since    19 May 2011
 */
public class ResolveCoordsActivityHealthChecker implements
		HealthChecker<ResolveCoordsActivity> {
	...
	public boolean canVisit(Object o) {
		...
		return o instanceof ResolveCoordsActivity;
	}
	...
	public VisitReport visit(ResolveCoordsActivity activity, List<Object> ancestry) {
		ResolveCoordsActivityConfigurationBean config = activity.getConfiguration();
		...
		*/
		...
		return new VisitReport(HealthCheck.getInstance(), activity,
				"Service OK", HealthCheck.NO_PROBLEM, subReports);
	}
