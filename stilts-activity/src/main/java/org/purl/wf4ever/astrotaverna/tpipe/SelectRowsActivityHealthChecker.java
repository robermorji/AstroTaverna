 ...
 * @since    19 May 2011
 */
public class SelectRowsActivityHealthChecker implements
		HealthChecker<SelectRowsActivity> {
	...
	public boolean canVisit(Object o) {
		...
		return o instanceof SelectRowsActivity;
	}
	...
	public VisitReport visit(SelectRowsActivity activity, List<Object> ancestry) {
		SelectRowsActivityConfigurationBean config = activity.getConfiguration();
