...
public class TcatListActivity extends
			...
			public void run() {
				...
				if(areMandatoryInputsNotNull()){
					...
					ReferenceService referenceService = context
							.getReferenceService();
					// Resolve inputs 				
					List<String> firstInput = (List<String>) referenceService.renderIdentifier(inputs.get(IN_FIRST_INPUT), 
	...
	//				}
					...
					if(!callbackfails){
						...
						parameters[2] = "in="+MyUtils.toSpacedString(firstInput);
						parameters[3] = "ofmt=votable";
						parameters[4] = "out="+outputTableName;
