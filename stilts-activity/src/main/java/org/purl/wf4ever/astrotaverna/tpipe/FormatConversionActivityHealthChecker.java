 ...
 * @since    19 May 2011
 */
public class FormatConversionActivityHealthChecker implements
		HealthChecker<FormatConversionActivity> {
	...
	public boolean canVisit(Object o) {
		...
		return o instanceof FormatConversionActivity;
	}
	...
	public VisitReport visit(FormatConversionActivity activity, List<Object> ancestry) {
		FormatConversionActivityConfigurationBean config = activity.getConfiguration();
