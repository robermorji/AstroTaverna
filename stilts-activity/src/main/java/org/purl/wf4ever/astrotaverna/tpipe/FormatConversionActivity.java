 ...
 * @since    19 May 2011
 */
public class FormatConversionActivity extends
		AbstractAsynchronousActivity<FormatConversionActivityConfigurationBean>
		implements AsynchronousActivity<FormatConversionActivityConfigurationBean> {
	...
	@Override
	public void configure(FormatConversionActivityConfigurationBean configBean)
		...
		callback.requestRun(new Runnable() {
			...
			public boolean areMandatoryInputsNotNull(){
				...
				if(inputs.get(IN_FIRST_INPUT_TABLE)==null
						|| inputs.get(IN_FORMAT_INPUT_TABLE)==null
						|| inputs.get(IN_FORMAT_OUTPUT_TABLE)==null)
					validStatus = false;
