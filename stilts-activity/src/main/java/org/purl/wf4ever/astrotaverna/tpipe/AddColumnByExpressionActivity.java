 ...
 * @since    19 May 2011
 */
public class AddColumnByExpressionActivity extends
		AbstractAsynchronousActivity<AddColumnByExpressionActivityConfigurationBean>
		implements AsynchronousActivity<AddColumnByExpressionActivityConfigurationBean> {
	...
	@Override
	public void configure(AddColumnByExpressionActivityConfigurationBean configBean)
		...
		callback.requestRun(new Runnable() {
			...
			public void run() {
				...
				if(areMandatoryInputsNotNull()){
					...
					String expression = (String) referenceService.renderIdentifier(inputs.get(IN_FILTER), String.class, context);
	...
	//				}
					...
					if(!callbackfails){
						...
						parameters[4] = "cmd=addcol "+ nameNewCol +" '( " + expression +" )'";
	...
	@Override
	public AddColumnByExpressionActivityConfigurationBean getConfiguration() {
