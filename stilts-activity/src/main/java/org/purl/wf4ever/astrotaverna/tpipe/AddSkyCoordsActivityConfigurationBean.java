 ...
 * @since    19 May 2011
 */
public class AddSkyCoordsActivityConfigurationBean implements Serializable {
	...
	private String typeOfInSystem;
	
	private String typeOfOutSystem;
	...
	public String getTypeOfInSystem() {
		return typeOfInSystem;
	}

	public void setTypeOfInSystem(String typeOfInSystem) {
		this.typeOfInSystem = typeOfInSystem;
	}

	public String getTypeOfOutSystem() {
		return typeOfOutSystem;
	}

	public void setTypeOfOutSystem(String typeOfOutSystem) {
		this.typeOfOutSystem = typeOfOutSystem;
	}
