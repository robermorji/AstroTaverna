 ...
 * @since    19 May 2011
 */
public class AddColumnByExpressionActivityHealthChecker implements
		HealthChecker<AddColumnByExpressionActivity> {
	...
	public boolean canVisit(Object o) {
		...
		return o instanceof AddColumnByExpressionActivity;
	}
	...
	public VisitReport visit(AddColumnByExpressionActivity activity, List<Object> ancestry) {
		AddColumnByExpressionActivityConfigurationBean config = activity.getConfiguration();
